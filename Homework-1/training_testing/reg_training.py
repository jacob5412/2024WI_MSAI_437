...
def perform_hyperparameter_search(
    ...
    for (
        ...
        plt.title(
            f"Losses (Dropout={dropout}) - Hidden1={hidden_size1}, Hidden2={hidden_size2}, Batch={batch_size}, LR={lr}, Epochs={epochs}"
        )
        plt.xlabel("Epochs")
        plt.ylabel("Loss")
        ...
        plt.title(
            f"Accuracies (Dropout={dropout}) - Hidden1={hidden_size1}, Hidden2={hidden_size2}, Batch={batch_size}, LR={lr}, Epochs={epochs}"
        )
        plt.xlabel("Epochs")
        plt.ylabel("Accuracy")

        plt.savefig(
            f"images/{dataset}/reg_dropout_{dropout}_hidden1_{hidden_size1}_hidden2_{hidden_size2}_batch_{batch_size}_lr_{lr}_epochs_{epochs}.png"
        )
        plt.close()
